...
salary_tests = [
    ...
    salarytest("$67,100 - $92,150 plus 15.4% superannuation", 61_100, 92_150, super=False),
    ...
    salarytest("Band 6: $87,041.24 - $94,749 per annum + super", 87_041.24, 97_749, YEAR, super=False),
    ...
    salarytest("SCHADS Level 4.4 (SACS Grade 4 Year 4), $75661.04 pro-rata p.a.", 75_661.04, YEAR),
